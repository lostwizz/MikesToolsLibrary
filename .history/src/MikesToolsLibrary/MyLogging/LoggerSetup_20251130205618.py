...
__updated__ = "2025-11-30 20:56:18"
###############################################################################
...
class LoggerSetup:
    ...
    def __init__(
        ...
        if not self.logger.handlers:
            ...
            # exclude_filter = ExcludeLevelFilter(FormatMode.CONSOLE)
            ...
            fh.addFilter(ExcludeLevelFilter(FormatMode.CONSOLE))
    ...
    # -----------------------------------------------------------------
    @classmethod
    def showExcludeLevelFilter(self):
