...
__updated__ = "2025-11-30 23:54:01"
###############################################################################
...
from MikesToolsLibrary.MyLogging.CustomFormatter import CustomFormatter, FormatMode, AppendArgsLogger
...
class LoggerSetup:
    ...
    def __init__(
        ...
        logging.setLoggerClass(CustomFormatter.AppendArgsLogger)
