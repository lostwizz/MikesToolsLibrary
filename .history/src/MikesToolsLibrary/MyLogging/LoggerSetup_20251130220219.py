...
__updated__ = "2025-11-30 22:02:19"
###############################################################################
...
class LoggerSetup:
    ...
    def __init__(
        ...
        if not self.logger.handlers:
            ...
            ######
            # File handler
            fh = self.setupFileHandler(level)
            self.logger.addHandler(fh)

            ######
            # SMTP handler
            mh = self.setupSMTPHandler(level)
    ...
    # -----------------------------------------------------------------
    def setupFileHandler(self, level):
    ...
    # -----------------------------------------------------------------
    def setupSMTPHandler(self, level):
        mail_handler = SMTPHandler(
            mailhost=("mail.merrett.ca", 465),
            fromaddr="mike@merrett.ca",
            toaddrs=["public@merrett.ca"],
            subject="Application Error",
            credentials=("user", "2]soaDOv;E;9"),
            secure=()
        )
