...
__updated__ = "2025-11-29 19:51:21"
###############################################################################
...
from MikesToolsLibrary.MyLogging.CustomFormatter import Cus
...
class LoggerSetup:
    ...
    def __init__(
        ...
        if not self.logger.handlers:
            ...
            ch.setLevel(level)
            ch.setFormatter(CustomFormatter(fmt="%(levelname)s: %(message)s", datefmt="%H:%M:%S", fmtMode=1))  # short, colored
