...
__updated__ = "2025-11-29 00:08:04"
###############################################################################
import logging
...
class LoggerSetup:
    ...
    def add_level(cls, level_name: str, level_num: int, colorFmt: str = None):
        ...
        # lvls = CustomLevels()
        print(repr(colorFmt))
        # lvls.add_log_level(level_name, level_num, colorFmt)
        # CustomLevels.add_log_level(level_name, level_num, colorFmt)
        CustomLevels.add_custom_level(level_name, level_num, colorFmt)
    ...
    def add_custom_level(self, level_name, level_num, method_name=None):
        ...
        return CustomLevels(level_name, level_num, method_name)
    ...
    # @classmethod
    # @log_decorator
    # def test(cls, fred:str = "fred was here"):
    #     print (f"Test called with {fred}")
