...
__updated__ = "2025-11-29 22:03:41"
###############################################################################
...
class CustomLevels:
    ...
    def addMyCustomLevels(self, logger) -> None:
        ...
        self.add("FAILURE", 92, "\x1b[1;31;44m", "❗❌ ")
        ...
        for b,bv in background.items():
            for f, fv in foreground.items():
                for a,av in attribs.items():
                    print (f"\x1b[0m  \033[{a};{f};{b}m ...A...{fv} on {bv} background with atrrib {av}      AaBbQrStUvWxYz--xxx++>\x1b[{a};{f};{b} \033[0m ")
