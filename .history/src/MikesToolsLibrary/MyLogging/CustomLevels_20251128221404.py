...
__updated__ = "2025-11-28 22:14:04"
###############################################################################
...
class CustomLevels:
    ...
    def add(name :str, id: int, fmt: str) -> None:
        ...
        CustomFormatter.COLORA[id]  = fmt + CustomFormatter.formatStr + CustomFormatter.reset

    # -----------------------------------------------------------------
    # def setupLogger( logger:logging, fileName:str, isTesting=False ) -> None:
    def setupLogger(logger: Logger, fileName: str, isTesting: bool = False) -> None:
        """
