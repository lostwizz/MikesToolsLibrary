...
__updated__ = "2025-11-30 19:56:17"
###############################################################################
...
class LoggerSetup:
    ...
    # -----------------------------------------------------------------
    @classmethod
    def addFilterLevel(self, level_to_exclude: int):
        """
    ...
    # -----------------------------------------------------------------
    def removeFilterLevel(self, level_to_remove:int):
        for handlier in self.logger.handlers:
