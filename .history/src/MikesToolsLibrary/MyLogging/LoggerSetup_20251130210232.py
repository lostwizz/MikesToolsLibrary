...
__updated__ = "2025-11-30 21:02:32"
###############################################################################
...
class LoggerSetup:
    ...
    # -----------------------------------------------------------------
    @classmethod
    def removeLevelExclude(self, level_to_remove:int, mode: FormatMode = None
):
        ExcludeLevelFilter.removeFilterLevel( level_to_remove)

    # -----------------------------------------------------------------
    @classmethod
    def showExcludeLevelFilter(self, mode: FormatMode = None):
