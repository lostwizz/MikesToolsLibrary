...
__updated__ = "2025-11-29 18:11:25"
###############################################################################
...
class CustomLevels:
    ...
    # -----------------------------------------------------------------
    @classmethod
    def add_log_level(cls, level_name, level_num, method_name=None, color=None, specialChars:str =N):
        if not method_name:
    ...
    # -----------------------------------------------------------------
    @classmethod
    def add(self, name :str, id: int, fmt: str, specialChars:str="") -> None:
        """
        ...
        """
        self.add_log_level(name, id, color=fmt, specialChars)
