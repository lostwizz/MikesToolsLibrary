...
__updated__ = "2025-11-28 21:06:16"
###############################################################################
import logging
import sys
...
class LoggerSetup:
    ...
    def add_custom_level(self, level_num: int, level_name: str, color_code: str = "\033[35m"):
        """
        Dynamically add a new custom level with color.
        """
        add_custom_level(level_num, level_name, color_code)
