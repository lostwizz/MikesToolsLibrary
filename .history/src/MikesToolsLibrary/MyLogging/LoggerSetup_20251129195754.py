...
__updated__ = "2025-11-29 19:57:54"
###############################################################################
...
class LoggerSetup:
    ...
    def __init__(
        ...
        if not self.logger.handlers:
            ...
            ch.setFormatter(
                CustomFormatter(
                    fmt="%(filename)s|%(lineno)4s|%(funcName)s|%(levelname)7s| %(message)s",
                    datefmt="%H:%M:%S",
            ...
            fh.setFormatter(
                CustomFormatter(
                    fmt="%(asctime)s|%(filename)s|%(lineno)4s|%(funcName)s|%(levelname)7s| %(message)s",
                    datefmt="%Y-%m-%d %H:%M:%S",
