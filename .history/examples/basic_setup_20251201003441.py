...
__updated__ = "2025-12-01 00:34:41"
###############################################################################
...
def displayExcludeLevel():
    ...
    logger.info("the next line is a Notice but will be filtered out in the file (but not CONSOLE)")
    logger.notice("This is a NOTICE message AFTER 2 - should NOT show on the CONSOLE (but will NOT CONSOLE)")
