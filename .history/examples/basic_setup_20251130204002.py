...
__updated__ = "2025-11-30 20:40:02"
###############################################################################
...
def displayExcludeLevel():
    ...
    mylog.LoggerSetup.addLevelExclude(logging._nameToLevel.get("NOTICE"))
    print( f"ExcludeLevelFilter {mylog.LoggerSetup.showExcludeLevelFilter() }")

    logger.notice("This is a NOTICE message AFTER 2 - should NOT")
