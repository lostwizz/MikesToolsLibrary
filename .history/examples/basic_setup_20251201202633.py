...
__updated__ = "2025-12-01 20:26:33"
###############################################################################
...
def main():
    global logger 
    logger = LoggerSetup("MikesToolsLibrary", level=logging.DEBUG, logfile="MikesToolsLibrary.log", modes= FormatMode.CONSOLE|).get_logger()
