...
__updated__ = "2025-12-23 23:09:29"
###############################################################################
...
class CustomLevels:
    ...
    def addMyCustomLevels(self, logger) -> None:
        ...
        self.add("data1read",     710, "\x1b[00;35;107m")
        self.add("data1ins",      711, "\x1b[00;35;107m")
        self.add("data1upd",      712, "\x1b[00;35;107m")
        self.add("data1del",      713, "\x1b[00;35;107m")
        self.add("data1cmp",      714, "\x1b[00;35;107m")
        self.add("data1noop",     715, "\x1b[00;35;107m")
        self.add("data1where",    716, "\x1b[00;35;107m")
        self.add("data1info",     717, "\x1b[00;35;107m")
        self.add("data1flds",     718, "\x1b[00;35;107m")

        self.add("data2read",     720, "\x1b[00;34;107m")
        self.add("data2ins",      721, "\x1b[00;34;107m")
        self.add("data2upd",      722, "\x1b[00;34;107m")
        self.add("data2del",      723, "\x1b[00;34;107m")
        self.add("data2cmp",      724, "\x1b[00;34;107m")
        self.add("data2noop",     725, "\x1b[00;34;107m")
        self.add("data2where",    726, "\x1b[00;34;107m")
        self.add("data2info",     727, "\x1b[00;34;107m")
        self.add("data2flds",     728, "\x1b[00;34;107m")

        self.add("data3read",     730, "\x1b[00;90;107m")
        self.add("data3ins",      731, "\x1b[00;90;107m")
        self.add("data3upd",      732, "\x1b[00;90;107m")
        self.add("data3del",      733, "\x1b[00;90;107m")
        self.add("data3cmp",      734, "\x1b[00;90;107m")
        self.add("data3noop",     735, "\x1b[00;90;107m")
        self.add("data3where",    736, "\x1b[00;90;107m")
        self.add("data3info",     737, "\x1b[00;90;107m")

        self.add("data4read",     740, "\x1b[00;32;107m")
        self.add("data4ins",      741, "\x1b[00;32;107m")
        self.add("data4upd",      742, "\x1b[00;32;107m")
        self.add("data4del",      743, "\x1b[00;32;107m")
        self.add("data4cmp",      744, "\x1b[00;32;107m")
        self.add("data4noop",     745, "\x1b[00;32;107m")
        self.add("data4where",    746, "\x1b[00;32;107m")
        self.add("data4info",     747, "\x1b[00;32;107m")
        self.add("data4flds",     748, "\x1b[00;32;107m")

        self.add("data5read",     750, "\x1b[00;95;107m")
        self.add("data5ins",      751, "\x1b[00;95;107m")
        self.add("data5upd",      752, "\x1b[00;95;107m")
        self.add("data5del",      753, "\x1b[00;95;107m")
        self.add("data5cmp",      754, "\x1b[00;95;107m")
        self.add("data5noop",     755, "\x1b[00;95;107m")
        self.add("data5where",    756, "\x1b[00;95;107m")
        self.add("data5info",     757, "\x1b[00;95;107m")
        self.add("data5flds",     758, "\x1b[00;95;107m")

        self.add("data6read",     760, "\x1b[00;36;107m")
        self.add("data6flds",     738, "\x1b[00;36;107m")
        self.add("data6ins",      761, "\x1b[00;36;107m")
        self.add("data6upd",      762, "\x1b[00;36;107m")
        self.add("data6del",      763, "\x1b[00;36;107m")
        self.add("data6cmp",      764, "\x1b[00;36;107m")
        self.add("data6noop",     765, "\x1b[00;36;107m")
        self.add("data6where",    766, "\x1b[00;36;107m")
        self.add("data6info",     767, "\x1b[00;36;107m")
        self.add("data6flds",     768, "\x1b[00;36;107m")

        self.add("data7read",     770, "\x1b[01;36;107m")
        self.add("data7ins",      771, "\x1b[01;36;107m")
        self.add("data7upd",      772, "\x1b[01;36;107m")
        self.add("data7del",      773, "\x1b[01;36;107m")
        self.add("data7cmp",      774, "\x1b[01;36;107m")
        self.add("data7noop",     775, "\x1b[01;36;107m")
        self.add("data7where",    776, "\x1b[01;36;107m")
        self.add("data7info",     777, "\x1b[01;36;107m")
        self.add("data7flds",     778, "\x1b[01;36;107m")

        self.add("data8read",     780, "\x1b[00;90;107m")
        self.add("data8ins",      781, "\x1b[00;90;107m")
        self.add("data8upd",      782, "\x1b[00;90;107m")
        self.add("data8del",      783, "\x1b[00;90;107m")
        self.add("data8cmp",      784, "\x1b[00;90;107m")
        self.add("data8noop",     785, "\x1b[00;90;107m")
        self.add("data8where",    786, "\x1b[00;90;107m")
        self.add("data8info",     787, "\x1b[00;90;107m")
        self.add("data8flds",     788, "\x1b[00;90;107m")

        self.add("data9read",     790, "\x1b[00;33;107m")
        self.add("data9ins",      791, "\x1b[00;33;107m")
        self.add("data9upd",      792, "\x1b[00;33;107m")
        self.add("data9del",      793, "\x1b[00;33;107m")
        self.add("data9cmp",      794, "\x1b[00;33;107m")
        self.add("data9noop",     795, "\x1b[00;33;107m")
        self.add("data9where",    796, "\x1b[00;33;107m")
        self.add("data9info",     797, "\x1b[00;33;107m")
        self.add("data9flds",     798, "\x1b[00;33;107m")
